...
// static void (*recieve_complete_callback)(uint16);
...
// void set_recieve_complete_callback(void (*f_ptr)(uint16))
// {
//     if (f_ptr)
//         recieve_complete_callback = f_ptr;
// }
...
void __vector_13(void)
{
    ...
    else
    {
        ...
        // recieve_complete_callback(data);
    }
}